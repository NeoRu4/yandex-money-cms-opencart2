...
$_['kassa_ym']     = 'Яндекс.Деньгах.';
$_['kassa_wm']     = 'WebMoney.';
$_['kassa_mobile'] = 'Счёта мобильного.';
$_['kassa_cards']  = 'Банковские карты.';
$_['kassa_cash']   = 'Наличные через терминалы.';
$_['kassa_sber']   = 'Сбербанк Онлайн.';
$_['kassa_alfa']   = 'Альфа-Клик.';
$_['kassa_ma']     = 'MasterPass.';
$_['kassa_pb']     = 'ОПромсвязьбанк.';
$_['kassa_qw']     = 'QIWI Wallet.';
...
$_['fast_pay_text']                  = 'Это платежная форма на ваш сайт. Позволяет принимать платежи на счет компании — с карт или из кошельков Яндекс.Денег, без договора. Для настройки нужен идентификатор Платежки: он придёт в письме, <a href="https://money.yandex.ru/fastpay/">когда вы соберете форму в конструкторе.</a>';
$_['fast_pay_enable_label']          = 'Включить прием платежей через Платежку';
$_['fast_pay_id_label']              = 'ID формы';
$_['fast_pay_purpose_label']         = 'Назначение платежа';
$_['fast_pay_narrative_placeholder'] = 'Номер заказа %order_id% Оплата через Яндекс.Платежку';
$_['fast_pay_os_label']              = 'Статус заказа';
$_['fast_pay_os_text']               = 'Статус должен показать, что результат платежа неизвестен: заплатил клиент или нет, вы можете узнать только из уведомления на электронной почте или в своем банке.';
$_['fast_pay_desc_text']             = 'Назначение будет в платежном поручении: напишите в нем всё, что поможет отличить заказ, который оплатили через Платежку.';

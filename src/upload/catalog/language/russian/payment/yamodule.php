...
$_['fast_pay_title']     = 'Яндекс.Платежка (банковские карты, кошелек)';
...
$_['text_method_mobile'] = 'Счёт мобильного.';
$_['text_method_cards']  = 'Банковские карты.';
$_['text_method_card']   = 'Банковские карты.';
$_['text_method_cash']   = 'Наличными через терминал.';
...
$_['text_method_2s']     = 'Сбербанк Бизнес Онлайн';
...
$_['b2b_sberbank_vat_error'] = "У вас в корзине товары, для которых действуют разные ставки НДС — их нельзя оплатить одновременно. Можно разбить покупку на несколько этапов: сначала оплатить товары с одной ставкой НДС, потом — с другой.";
